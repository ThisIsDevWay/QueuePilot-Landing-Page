  ...
  return (
    <div className="container mx-auto px-4 py-16 md:py-24">
      ...
      <div className="prose lg:prose-xl max-w-4xl mx-auto text-foreground/80">
        ...
        <h2 className="font-headline text-primary">2. Changes to Terms or Services</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">3. Who May Use the Services?</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">4. Content and Content Rights</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">5. General Prohibitions and QueuePilot's Enforcement Rights</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">8. Limitation of Liability</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">9. Contact Information</h2>
        <p>

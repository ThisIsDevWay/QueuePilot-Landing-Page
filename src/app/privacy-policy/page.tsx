...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-16 md:py-24">
      <h1 className="font-headline text-3xl md:text-4xl font-bold text-primary mb-8 text-center">
        {t('footer.privacyPolicy')}
      </h1>
      <div className="prose lg:prose-xl max-w-4xl mx-auto text-foreground/80">
        <p>Last updated: {new Date().toLocaleDateString()}</p>

        <h2 className="font-headline text-primary">1. Introduction</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">2. Information We Collect</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">3. How We Use Your Information</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">4. Will Your Information Be Shared With Anyone?</h2>
        <p>
          We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.
        </p>

        <h2 className="font-headline text-primary">5. How Long Do We Keep Your Information?</h2>
        <p>
          We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law (such as tax, accounting or other legal requirements).
        </p>

        <h2 className="font-headline text-primary">6. How Do We Keep Your Information Safe?</h2>
        <p>
          We have implemented appropriate technical and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards and efforts to secure your information, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure.
        </p>

        <h2 className="font-headline text-primary">7. What Are Your Privacy Rights?</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">8. Updates to This Notice</h2>
        <p>
        ...
        <h2 className="font-headline text-primary">9. How Can You Contact Us About This Notice?</h2>
        <p>
